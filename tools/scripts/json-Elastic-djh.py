# Maral Dadvar
#This code transformes the djh dataset generated for JudaicaLink into the format adaptable to Elasticsearch.
#27/05/2018
#Ver. 01
...
file = io.open('textfile-djh.json','w' , encoding ='utf-8')
