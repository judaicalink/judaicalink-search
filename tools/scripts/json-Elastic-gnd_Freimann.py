# Maral Dadvar
#This code transformes the Freimann dataset generated for JudaicaLink into the format adaptable to Elasticsearch.
#26/05/2018
#Ver. 01
...
file = io.open('textfile-gnd_freimann.json','w' , encoding ='utf-8')
