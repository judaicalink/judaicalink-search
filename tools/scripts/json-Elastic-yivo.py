# Maral Dadvar
#This code transformes the yivo dataset generated for JudaicaLink into the format adaptable to Elasticsearch.
#29/05/2018
#Ver. 01
...
file = io.open('textfile-yivo.json','w' , encoding ='utf-8')
